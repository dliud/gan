...
def main():
    ...
    c_orig.train(orig_data_loader, num_epoch=150, synth=False)
    c_synth.train(synth_data_loader, num_epoch=150, synth=True)
    print("Orig accuracy: {}", utils.get_accuracy(c_orig))
    print("Synthetic accuracy: {}", utils.get_accuracy(c_synth))
